...
@section('title')
Manufacturing Orders | {{ config('app.name') }}
@endsection
...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Manufacturing Orders</div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body d-flex justify-content-between">
                    <a href="{{ route('dashboard.manufacturing-orders.create') }}" class="btn btn-primary"><i
