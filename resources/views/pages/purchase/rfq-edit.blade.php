...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Edit RFQ</div>
    </div>
</div>
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.purchase.rfq.update', $purchase->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="row form-bahan-baku mb-2">
                                        <div class="col-md-3">
                                            <select name="id_bahan[]" required class="form-control bahan-baku-select">
                                                ...
                                                <option value="{{ $material->id }}" {{ old('id_bahan[]', $item->id_bahan)==$material->id ?
                                                    'selected' :
                                                    ''
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" class="form-control satuan-input" name="satuan[]" required
                                                value="{{ old('satuan[]', $item->satuan) }}" placeholder="satuan" readonly>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" class="form-control harga-input" name="harga[]" required
                                                value="{{ old('harga[]', $item->harga) }}" placeholder="harga" readonly>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" class="form-control total-harga-input" name="total_harga[]"
                                                required value="{{ old('total_harga[]', $item->total_harga) }}" placeholder="Total Harga"
                                                readonly>
                                        </div>
