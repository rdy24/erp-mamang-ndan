...
@section('title')
Tambah Quotation | {{ config('app.name') }}
@endsection
...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Tambah Quotation</div>
    </div>
</div>
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.sale.quotation.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <select name="quotation_template_id" class="form-control select2" id="quotation_template">
                                ...
                                <option value="{{ $template->id }}" {{ old('quotation_template_id')==$template->id ?
                                    'selected' :
                                    ''
                                    }}>
                                    {{ $template->title }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="expired_date" id="expired_date" class="form-control datepicker">
                        </div>
                        <div class="form-group">
