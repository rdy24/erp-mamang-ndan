...
@section('title')
Tambah Quotation Template | {{ config('app.name') }}
@endsection
...
<div class="section-header">
    <h1>Tambah Quotation Template</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item"><a href="#">Dashboard</a></div>
        <div class="breadcrumb-item active">Tambah Quotation Template</div>
    </div>
</div>
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.quotation-template.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="expired">Jangka Expired (hari)</label>
                            <input type="number" name="expired" id="expired" class="form-control">
                        </div>
                        <div class="form-group">
                                ...
                                <div class="row form-bahan-baku mb-2">
                                    <div class="col-md-5">
                                        <select name="id_produk[]" required class="form-control">
                                            ...
                                            <option value="{{ $product->id }}" {{ old('id_produk[]')==$product->id ?
                                                'selected' :
                                                ''
                                                }}>
                                                {{ $product->nama_produk }}
