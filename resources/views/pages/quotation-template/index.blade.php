...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Quotation Template</div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body d-flex justify-content-between">
                    <a href="{{ route('dashboard.quotation-template.create') }}" class="btn btn-primary"><i
                        ...
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->title }}</td>
                                    <td>{{ $item->expired }} (Hari)</td>
                                    <td>
                                        <a href="{{ route('dashboard.quotation-template.show', $item->id) }}"
