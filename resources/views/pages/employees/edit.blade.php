                    ...
                    <form action="{{ route('dashboard.employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="job_position_id" class="form-control select2" id="job_position_id">
                                ...
                                <option value="{{ $jobPosition->id }}" {{ old('job_position_id', $employee->job_position_id)==$jobPosition->id ? 'selected' :''}}>
                                    {{ $jobPosition->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <img class="img-preview img-fluid mb-3 col-sm-5 d-block" src="{{ asset('uploads/employee/' . $employee->photo) }}">
                            @error('photo')
                            <p class="text-danger">
                                {{ $message }}
                            </p>
