...
<section class="section">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            ...
            <a href="{{ route('dashboard.vendors.print') }}" class="btn btn-primary">
            ...
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('dashboard.vendors.destroy', $vendor->id) }}" class="btn btn-danger" data-confirm-delete="true">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
